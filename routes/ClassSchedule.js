...
router.get("/GetAll", async (req, res) => {
    //let collectionFitnessClass = await db.collection("ClassSchedule");
    let results = await db.collection("ClassSchedule").aggregate([
      { 
        $addFields: {
  ...
  router.get("/GetAllNameID", async (req, res) => {
    let collection = await db.collection("ClassSchedule");
